...
public class BioHarnessSettings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnPreferenceClickListener {

	public static final String APP_PREFERENCES_FILE = "preferences";

	private static final String TAG = BioHarnessSettings.class.getSimpleName();
